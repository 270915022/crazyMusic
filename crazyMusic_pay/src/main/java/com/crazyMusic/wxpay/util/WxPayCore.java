package com.crazyMusic.wxpay.util;
...
import com.crazyMusic.wxpay.config.WxPayConfig;
import com.crazyMusic.wxpay.model.Unifiedorder;
import com.crazyMusic.wxpay.model.UnifiedorderResult;
import com.crazyMusic.wxpay.model.WXPayResult;
...
public class WxPayCore{
	 ...
	 */
	public static SortedMap<Object,Object> createWxPayParam(String out_trade_no,String total_fee){
		...
		//对象进行存储
		Unifiedorder unifiedorder = new Unifiedorder(WxPayConfig.appid, WxPayConfig.mch_id, nonce_str, sign, WxPayConfig.body, out_trade_no, payMoney, WxPayConfig.spbill_create_ip, WxPayConfig.notify_url, WxPayConfig.trade_type);
