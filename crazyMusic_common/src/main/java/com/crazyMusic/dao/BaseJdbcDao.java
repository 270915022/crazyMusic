...
public class BaseJdbcDao {
     ...
     * @return
     */
    public String getIn(String fieldName,Object...args) {
    	StringBuilder sbIn = new StringBuilder(" "+fieldName+" in ( ");
    	for (Object parm : args) {
    		sbIn.append("'"+parm+"',");
		}
    	return sbIn.substring(0, sbIn.length()-1)+")";
    }
    ...
    public int getCount(String sql,Object ...args) {
    	JSONObject countJSON = queryForJsonObject("select count(1) as count from (" + sql + ") as temp$$count",args);
    	return countJSON.getIntValue("count");
    }
     ...
     */
    public int insert(String tableName, JSONObject data) {
     ...
     * @param list 插入数据集合
     */
    public void insertBatch(String tableName, final List<LinkedHashMap<String, Object>> list) {
