...
public class RedisManager {
   ...
   public JedisPool getPool() {    
    ...
    private static final RedisManager jedisUtil = new RedisManager();  
   ...
   public static void main(String[] args) {  
       RedisManager jedisUtil= RedisManager.getInstance();    
       RedisManager.Strings strings=jedisUtil.new Strings();  
